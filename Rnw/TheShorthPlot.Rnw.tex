...
%
%         TheShorthPlot {Technical Report}
%  
...
<<fig=TRUE, echo=FALSE,label=SPalpha01, height=12, width=8, include=FALSE>>=
oldpar <-par(mfrow=c(3,3))
ps <- c(0.125,0.25,0.5,0.75,0.875)
uniform <-ru50$uniform;  lshorth(uniform, probs=ps,  rescale="neg",  frame.plot=FALSE, 
legend = NULL,  ylim=c(1,0), main=NULL);
normal<-ru50$normal; lshorth(normal, probs=ps,  xlim=c(-3,3), rescale="neg", frame.plot=FALSE,  legend = NULL, main=NULL)
lognormal<- ru50$lognormal; lshorth(lognormal, probs=ps,    xlim=c(0,10), rescale="neg", frame.plot=FALSE,  legend =NULL, main=NULL);

n<-200
uniform <-ru200$uniform;  lshorth(uniform, probs=ps,  rescale="neg",  frame.plot=FALSE, 
legend = NULL,  ylim=c(1,0), main=NULL);
normal<-ru200$normal; lshorth(normal, probs=ps,   xlim=c(-3,3),  rescale="neg", frame.plot=FALSE,  legend = NULL, main=NULL)
lognormal<- ru200$lognormal; lshorth(lognormal, probs=ps,  xlim=c(0,10), rescale="neg", frame.plot=FALSE,  legend = NULL, main=NULL);
...
legend = NULL,  ylim=c(1,0), main=NULL, rug=FALSE, xlab="uniform");
normal<-ru10000$normal; lshorth(normal, probs=ps,    xlim=c(-3,3), rescale="neg", frame.plot=FALSE,  legend = NULL, main=NULL, rug=FALSE, xlab="normal")
lognormal<- ru10000$lognormal; lshorth(lognormal, probs=ps, xlim=c(0,10),  rescale="neg", frame.plot=FALSE, legend="bottomleft", main=NULL, rug=FALSE, xlab="lognormal");


par(oldpar)
@
%: SPalpha02  for tilburg paper -1
<<fig=TRUE, echo=FALSE,label=SPalpha02, height=12, width=8, include=FALSE>>=
oldpar <-par(mfrow=c(3,3))
ps <- c(0.125,0.25,0.5,0.75,0.875)
uniform <-ru50$uniform;  lshorth(uniform, probs=ps,  rescale="neg",  frame.plot=FALSE, 
legend = NULL,  ylim=c(1,0), main=NULL);
...
legend = NULL,  ylim=c(1,0), main=NULL);
normal<-ru200$normal; lshorth(normal, probs=ps,   xlim=c(-3,3),  rescale="neg", frame.plot=FALSE,  legend = NULL, main=NULL)
lognormal<- ru200$lognormal; lshorth(lognormal, probs=ps,  xlim=c(0,8),  ylim=c(8,0),  rescale="neg", frame.plot=FALSE,  legend = NULL, main=NULL);
...
legend = NULL,  ylim=c(1,0), main=NULL, rug=FALSE, xlab="uniform");
normal<-ru10000$normal; lshorth(normal, probs=ps,    xlim=c(-3,3), rescale="neg", frame.plot=FALSE,  legend = NULL, main=NULL, rug=FALSE, xlab="normal")
lognormal<- ru10000$lognormal; lshorth(lognormal, probs=ps, xlim=c(0,8),  ylim=c(8,0), rescale="neg", frame.plot=FALSE, legend="bottomleft", main=NULL, rug=FALSE, xlab="lognormal");
...
%<<fig=TRUE, echo=FALSE,label=SPalpha02, height=12, width=8, include=FALSE>>=
<<fig=true, echo=FALSE,  label=Faithfulhist, include=FALSE>>=
hist(faithful$eruptions,main="Old Faithful Geyser\nEruption Durations", xlab="duration")
#hist(faithful$eruptions,main="Old Faithful Geyser\nEruption Durations", xlab="duration",xlim=c(0,6))
#rug(faithful$eruptions, quiet=TRUE)
@
<<fig=true, echo=FALSE,   label=Faithfulbox, include=FALSE>>=
boxplot(faithful$eruptions,main="Old Faithful Geyser\nEruption Durations",frame.plot=FALSE, horizontal=TRUE)
@

<<fig=true, echo=FALSE, label=Faithfuldens, include=FALSE>>=
plot(density(faithful$eruptions),main="Eruption duration [min]", frame.plot=FALSE)
rug(faithful$eruptions, quiet=TRUE)
@
%\begin{figure}[htb]
...
lshorth(faithful$eruptions, probs=c(0.125,0.25,0.5,0.75, 0.875), rescale="neg", frame.plot=FALSE,  legend="right", main="",xlab="Eruption duration [min], n=272")
@
%\begin{minipage}0.4\linewidth
%\begin{figure}[htb]
...
lshorth(chondrite$V1,rescale="neg", frame.plot=FALSE,  legend="bottom", main="", xlab="silicate content, n=22")
@
%\begin{figure}[htb]
