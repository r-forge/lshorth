...
%$Header: /u/math/j40/cvsroot/lectures/src/shorth/Rnw/lshorth.Rnw.tex,v 1.12 2007/09/08 19:17:07 j40 Exp $
...
\keywords{shorth, distribution diagnostics, data analysis, peobability mass concentration}
...
plot(density(chondrite$V1), main="")
...
HHat<-rhhat(25)
#hist(x25); plot(density(x25)); lshorth(x25,   rescale="neg", legend = NULL)
...
\verb+$Revision: 1.12 $+\\
\verb+$Date: 2007/09/08 19:17:07 $+\\
\verb+$Name:  $+\\
\verb+$Author: j40 $+\\
\begin{verbatim}
$Log: lshorth.Rnw.tex,v $
Revision 1.12  2007/09/08 19:17:07  j40
sync
